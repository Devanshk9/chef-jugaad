...
export default function Main(){
    ...
    const [recipeRandom, setRecipeRamdom] = React.useState("")
    ...
    <main>
        ...
        <button onClick={getRandom}>Recipe with Random Ingredients</button>
        {recipeRandom && <Recipe recipe = {recipeRandom}/>}
